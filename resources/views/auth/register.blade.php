                    ...
                    <div class="card-body register-page">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <input id="firstname" type="text"
                                        class="form-control rounded-0 @error('firstname') is-invalid @enderror"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <input id="name" type="text"
                                        ...
                                        placeholder="{{ __('Last Name') }}" name="name" value="{{ old('name') }}"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <input id="cin" type="text"
                                        class="form-control rounded-0 @error('cin') is-invalid @enderror"
                                        placeholder="{{ __('CIN') }}" name="cin" value="{{ old('cin') }}" required
                                        autocomplete="cin">
                            ...
                            <div class="row mb-0">
                                ...
                                <a href="{{ route('login') }}" class="link-secondary fw-bold mt-2">You have already an
