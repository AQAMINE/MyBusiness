    ...
    @auth
            ...
            <div class="row information-update-zone bg-dark">
                        ...
                        <table class="table table-dark">
                            ...
                            <tr>
                                ...
                                <td><textarea name="role_in_company"
                                        class="form-control-plaintext form-control-dark-mode rounded-0">{{ $datas->role_incompany }}</textarea>
                                </td>
                            </tr>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card bg-dark text-light">
                        <img src="{{ asset('UsersProfilesPictures/' . Auth::user()->profile_pic) }}" class="card-img-top"
                            alt="...">
                        <div class="card-body">
        ...
        <div class="modal fade" id="RemoveuserModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <form action="{{ route('close.account', $datas->id) }}" method="post">
                    {{ csrf_field() }}
