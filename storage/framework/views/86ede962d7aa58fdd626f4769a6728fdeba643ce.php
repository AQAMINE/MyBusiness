<?php $__env->startSection('content'); ?>
    ...
    <?php if(auth()->guard()->check()): ?>
            ...
            <div class="card text-white bg-dark mb-1 rounded-0">
                ...
                <div class="crad-footer mb-2">
                    ...
                    <a href="#" class="btn btn-success btn-sm rounded-0 ml-2" data-bs-toggle="modal"
                        ...
                        onclick="EditLocalAds(<?php echo e($ad->id); ?>,'<?php echo e($ad->content); ?>','<?php echo e(date('Y-m-d\TH:i', strtotime($ad->created_at))); ?>',<?php echo e($ad->end_date); ?>,<?php echo e($ad->status); ?>)"><i
        ...
        <div class="modal fade" id="EditLocalAdModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <form action="<?php echo e(route('LocalAds.store')); ?>" method="POST" ß>
                    <?php echo e(csrf_field()); ?>
