<nav id="sidebar">
    ...
    <div class="img bg-wrap text-center py-4" style="background-image: url(<?php echo e(asset('UsersProfilesPictures/bg_1.jpg' )); ?>);">
        <div class="user-logo">
            <div class="img  "
    ...
    <ul class="list-unstyled components mb-5">
        ...
        <?php endif; ?>
        <li <?php if(Request::route()->getName() == 'showProfile'): ?> class="active" <?php endif; ?>>
            <a href="<?php echo e(route('showProfile' , Auth::id())); ?>"><span class="fa fa-user mr-3"></span> Profile</a>
        </li>
        <li>
