                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="toast rounded-0 fade show" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false" >
                                ...
                                <!--Strat if user is admin show here task for user (user firstname and last name) if a normal user show here task aded by admin fullname-->
                                    ...
                                    <?php else: ?> <?php echo e($task->user->firstname); ?> <?php echo e($task->user->name); ?></strong> <?php endif; ?> </strong>
                                ...
                                <div class="mt-2 pt-2 border-top">
                                    ...
                                    <?php if(Auth::user()->approvement == 1  && Auth::user()->role == 1): ?>
                                        <a  onclick="EditTask(<?php echo e($task->id); ?>,<?php echo e($task->privacy); ?>,'<?php echo e($task->taskTitle); ?>','<?php echo e($task->task); ?>')" class="btn btn-info btn-sm rounded-0" data-bs-toggle="modal" data-bs-target="#EditTaskModal">Edit</a>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taskdone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($taskdone->done == 1): ?>
                        ...
                        <!--End Show Task For User If Session Admin-->
                            <td><a href="<?php echo e(route('TaskUndone', $taskdone->id)); ?>"  class="btn btn-warning btn-sm rounded-0">Undone</a></td>
                            <!--Admin can remove task-->
                            <?php if(Auth::user()->approvement == 1  && Auth::user()->role == 1): ?>
